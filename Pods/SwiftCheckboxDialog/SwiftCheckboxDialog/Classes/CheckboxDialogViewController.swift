...
open class CheckboxDialogViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func okButtonAction(_ sender: UIButton!) {
        ...
        self.delegateDialogTableView?.onCheckboxPickerValueChange(self.componentName!, values: self.selectedValues,isConfirm:true)
    ...
    func cancelButtonAction(_ sender: UIButton!) {
        ...
        self.delegateDialogTableView?.onCheckboxPickerValueChange(self.componentName!, values: self.selectedValues,isConfirm:false)
        self.dismiss(animated: false, completion: nil)
    }
